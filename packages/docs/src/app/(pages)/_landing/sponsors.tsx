...
export type Sponsors = z.infer<typeof sponsorSchema>[]
  ...
  return (
    <section className="mb-24">
      ...
      <div className="mb-12 flex flex-wrap items-center justify-center gap-8">
        ...
        >
          <ShadcnStudioIcon className="size-8" />
  ...
  return (
    ...
    >
      <section className="text-muted-foreground space-y-4 rounded-md border border-dashed px-4 py-6 text-center transition-colors group-hover:text-current group-active:text-current">
        <NextJSWeeklyLogo className="mx-auto w-3/4" />
...
export function NextJSWeeklyLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 200 19"
...
export function ShadcnStudioIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 328 329"
      fill="none"
