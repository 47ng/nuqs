  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="container grid grid-cols-1 gap-x-12 gap-y-24 px-4 py-24 md:grid-cols-2 xl:grid-cols-3">
          <Feature
            icon={
              <svg
                width="1.15em"
          ...
          <Feature
            ...
            description={
              <>
                <code>useQueryStates</code> hook to manage multiple keys at
                once.
              </>
            }
          />
    ...
    <>
      <div className="space-y-4 xl:space-y-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold tracking-tighter dark:text-white md:text-3xl xl:text-4xl">
            {title}
            {isNew && (
              <sup className="ml-2" title="New feature">
                ✨
              </sup>
            )}
          </h2>
