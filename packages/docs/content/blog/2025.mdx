...
Kent C Dodds, Tejas Kumar, David Khourshid, Aurora Scharff, Dominik Dorfmeister, and many more.

I had been chatting with [Aurora](https://aurorascharff.no/) before the conference about some optimistic update problems
...
The biggest surprise though was that [David](https://stately.ai/) (whose talk was just before mine)
...
I also met Dominik ([TkDodo](https://tkdodo.eu)) IRL for the first time.
...
with the audience. Thanks [Amber Shand](https://www.ambershand.co.uk/) for MCing! 🦆🦆😉

## The Horde

Of all the people I met online this year, one stands out: [OrcDev](https://orcdev.com),
...
On the personal side, I have been neck deep in [client work](https://mailto:consulting@francoisbest.com)
for the last few months, so the backlog of issues & PRs has been growing. Big thanks to regular contributors like [Dominik Koch](https://dominikkoch.dev/) & TkDodo
...
1. Solid funding (through [sponsors 💖](https://github.com/sponsors/franky47))
...
and helping friends like OrcDev, [Alem Tuzlak](https://github.com/AlemTuzlak) (maintainer of TanStack AI & Devtools),
and [Virgile Rietsch](https://www.blitzreels.com) with their audio setup, I realised something:
