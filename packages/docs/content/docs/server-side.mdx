...
<HumanContent>
<AnchoredTabs items={["Next.js (app router)", "Next.js (pages router)", "API routes", "Remix / React Router", "React / client-side"]}>

<Tab value="Next.js (app router)" id="nextjs-app-router">
...
<Tab value="Next.js (pages router)" id="nextjs-pages-router">
...
<Tab value="Remix / React Router" id="remix-react-router">
...
<Tab value="React / client-side" id="react-client-side">
...
<Tab value="API routes" id="api-routes">
