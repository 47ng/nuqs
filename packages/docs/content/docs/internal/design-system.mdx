...
import { impactLabels, KNOWN_IMPACT_LABELS } from 'scripts/lib/changelog-dto'
...
then adapters), colored like their GitHub labels with AAA-contrast text:

<ReleaseImpacts labels={impactLabels(KNOWN_IMPACT_LABELS)} />
