...
<FeatureSupportMatrix introducedInVersion='2.5.0' supportedFrameworks={['React Router (v6)', 'React Router (v7)', 'Remix']}/>
<FeatureSupportMatrix introducedInVersion='2.5.0' supportedFrameworks={['Next.js (app router)']}/>
<FeatureSupportMatrix introducedInVersion='2.5.0' deprecatedInVersion='2.6.0' />
<FeatureSupportMatrix introducedInVersion='2.5.0' deprecatedInVersion='2.6.0' supportedFrameworks={['React Router (v6)', 'React Router (v7)', 'Remix']}/>
<FeatureSupportMatrix introducedInVersion='2.5.0' deprecatedInVersion='2.6.0' supportedFrameworks={['Next.js (app router)']}/>
