...
### Full page navigation on <br className='hidden in-[#nd-toc]:block'/>`shallow: false{:ts}` [#full-page-navigation-on-shallow-false]
...
## <ReactRouter className='inline mr-1.5 -mt-1' role="presentation"/> React Router v7 [#react-router-v7]
...
## <ReactRouter className='inline mr-1.5 -mt-1' role="presentation"/> React Router v8 [#react-router-v8]
