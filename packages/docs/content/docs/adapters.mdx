...
## <HumanContent><NextJS className='inline mr-2 -mt-1' role="presentation" /></HumanContent>Next.js [#nextjs]
...
## <HumanContent><ReactSPA className='inline mr-2 -mt-1' role="presentation"/></HumanContent>React SPA [#react-spa]
...
## <HumanContent><ReactRouter className='inline mr-2 -mt-1' role="presentation"/></HumanContent>React Router v6 [#react-router-v6]
...
## <HumanContent><ReactRouter className='inline mr-2 -mt-1' role="presentation"/></HumanContent>React Router v7 [#react-router-v7]
...
## <HumanContent><Vitest className='inline mr-2 -mt-1' role="presentation"/></HumanContent>Testing
