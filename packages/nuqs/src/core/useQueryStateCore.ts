...
export interface UseQueryStateCoreOptions<T> extends Parser<T>, Options {}

export type UseQueryStateCoreReturn<Parsed, Default> = [
 ...
 */
export function useQueryStateCore<T>(
  key: string,
 ...
 */
export function useQueryStateCore(
  key: string,
  adapter: AdapterInterface,
  options: Options & {
    defaultValue: string
 ...
 */
export function useQueryStateCore<T = string>(
  key: string,
  adapter: AdapterInterface,
  {
    history = 'replace',
    ...
    clearOnDefault = true,
    startTransition
  }: Partial<UseQueryStateCoreOptions<T>> & {
    defaultValue?: T
  } = {
    history: 'replace',
    scroll: false,
